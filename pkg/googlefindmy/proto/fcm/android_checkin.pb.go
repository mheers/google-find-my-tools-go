...
// 	protoc        (unknown)
// source: fcm/android_checkin.proto
...
func (DeviceType) Descriptor() protoreflect.EnumDescriptor {
	return file_fcm_android_checkin_proto_enumTypes[0].Descriptor()
}

func (DeviceType) Type() protoreflect.EnumType {
	return &file_fcm_android_checkin_proto_enumTypes[0]
}
...
func (DeviceType) EnumDescriptor() ([]byte, []int) {
	return file_fcm_android_checkin_proto_rawDescGZIP(), []int{0}
}
...
func (ChromeBuildProto_Platform) Descriptor() protoreflect.EnumDescriptor {
	return file_fcm_android_checkin_proto_enumTypes[1].Descriptor()
}

func (ChromeBuildProto_Platform) Type() protoreflect.EnumType {
	return &file_fcm_android_checkin_proto_enumTypes[1]
}
...
func (ChromeBuildProto_Platform) EnumDescriptor() ([]byte, []int) {
	return file_fcm_android_checkin_proto_rawDescGZIP(), []int{0, 0}
}
...
func (ChromeBuildProto_Channel) Descriptor() protoreflect.EnumDescriptor {
	return file_fcm_android_checkin_proto_enumTypes[2].Descriptor()
}

func (ChromeBuildProto_Channel) Type() protoreflect.EnumType {
	return &file_fcm_android_checkin_proto_enumTypes[2]
}
...
func (ChromeBuildProto_Channel) EnumDescriptor() ([]byte, []int) {
	return file_fcm_android_checkin_proto_rawDescGZIP(), []int{0, 1}
}
...
func (x *ChromeBuildProto) Reset() {
	*x = ChromeBuildProto{}
	mi := &file_fcm_android_checkin_proto_msgTypes[0]
...
func (x *AndroidCheckinProto) Reset() {
	*x = AndroidCheckinProto{}
	mi := &file_fcm_android_checkin_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AndroidCheckinProto) Descriptor() ([]byte, []int) {
	return file_fcm_android_checkin_proto_rawDescGZIP(), []int{1}
}
...
var File_fcm_android_checkin_proto protoreflect.FileDescriptor

const file_fcm_android_checkin_proto_rawDesc = "" +
	"\n" +
	"\x19fcm/android_checkin.proto\x12\rcheckin_proto\"\xac\x03\n" +
	...
	"\x10DEVICE_CHROME_OS\x10\x04BLH\x03ZHgithub.com/mheers/google-find-my-tools-go/pkg/googlefindmy/proto/fcm;fcm"

var (
	file_fcm_android_checkin_proto_rawDescOnce sync.Once
	file_fcm_android_checkin_proto_rawDescData []byte
)

func file_fcm_android_checkin_proto_rawDescGZIP() []byte {
	file_fcm_android_checkin_proto_rawDescOnce.Do(func() {
		file_fcm_android_checkin_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_fcm_android_checkin_proto_rawDesc), len(file_fcm_android_checkin_proto_rawDesc)))
	})
	return file_fcm_android_checkin_proto_rawDescData
}

var file_fcm_android_checkin_proto_enumTypes = make([]protoimpl.EnumInfo, 3)
var file_fcm_android_checkin_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_fcm_android_checkin_proto_goTypes = []any{
...
var file_fcm_android_checkin_proto_depIdxs = []int32{
...
func init() { file_fcm_android_checkin_proto_init() }
func file_fcm_android_checkin_proto_init() {
	if File_fcm_android_checkin_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_fcm_android_checkin_proto_rawDesc), len(file_fcm_android_checkin_proto_rawDesc)),
			NumEnums:      3,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_fcm_android_checkin_proto_goTypes,
		DependencyIndexes: file_fcm_android_checkin_proto_depIdxs,
		EnumInfos:         file_fcm_android_checkin_proto_enumTypes,
		MessageInfos:      file_fcm_android_checkin_proto_msgTypes,
	}.Build()
	File_fcm_android_checkin_proto = out.File
	file_fcm_android_checkin_proto_goTypes = nil
	file_fcm_android_checkin_proto_depIdxs = nil
}
