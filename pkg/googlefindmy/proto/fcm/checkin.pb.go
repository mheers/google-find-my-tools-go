...
func (x *GservicesSetting) Reset() {
	*x = GservicesSetting{}
	mi := &file_fcm_checkin_proto_msgTypes[0]
...
func (*GservicesSetting) Descriptor() ([]byte, []int) {
	return file_fcm_checkin_proto_rawDescGZIP(), []int{0}
}
...
func (x *AndroidCheckinRequest) Reset() {
	*x = AndroidCheckinRequest{}
	mi := &file_fcm_checkin_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AndroidCheckinRequest) Descriptor() ([]byte, []int) {
	return file_fcm_checkin_proto_rawDescGZIP(), []int{1}
}
...
func (x *AndroidCheckinResponse) Reset() {
	*x = AndroidCheckinResponse{}
	mi := &file_fcm_checkin_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AndroidCheckinResponse) Descriptor() ([]byte, []int) {
	return file_fcm_checkin_proto_rawDescGZIP(), []int{2}
}
...
var File_fcm_checkin_proto protoreflect.FileDescriptor

const file_fcm_checkin_proto_rawDesc = "" +
	"\n" +
	"\x11fcm/checkin.proto\x12\rcheckin_proto\x1a\x19fcm/android_checkin.proto\"<\n" +
	...
	"\fversion_info\x18\v \x01(\tR\vversionInfoBLH\x03ZHgithub.com/mheers/google-find-my-tools-go/pkg/googlefindmy/proto/fcm;fcm"

var (
	file_fcm_checkin_proto_rawDescOnce sync.Once
	file_fcm_checkin_proto_rawDescData []byte
)

func file_fcm_checkin_proto_rawDescGZIP() []byte {
	file_fcm_checkin_proto_rawDescOnce.Do(func() {
		file_fcm_checkin_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_fcm_checkin_proto_rawDesc), len(file_fcm_checkin_proto_rawDesc)))
	})
	return file_fcm_checkin_proto_rawDescData
}

var file_fcm_checkin_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_fcm_checkin_proto_goTypes = []any{
...
var file_fcm_checkin_proto_depIdxs = []int32{
...
func init() { file_fcm_checkin_proto_init() }
func file_fcm_checkin_proto_init() {
	if File_fcm_checkin_proto != nil {
		return
	}
	file_fcm_android_checkin_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_fcm_checkin_proto_rawDesc), len(file_fcm_checkin_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_fcm_checkin_proto_goTypes,
		DependencyIndexes: file_fcm_checkin_proto_depIdxs,
		MessageInfos:      file_fcm_checkin_proto_msgTypes,
	}.Build()
	File_fcm_checkin_proto = out.File
	file_fcm_checkin_proto_goTypes = nil
	file_fcm_checkin_proto_depIdxs = nil
}
